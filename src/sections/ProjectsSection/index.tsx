        ...
        <section id="projects" className="bg-zinc-800/30 box-border caret-transparent py-20">
            <div className="box-border caret-transparent max-w-screen-xl mx-auto px-4 md:px-8">
                ...
                <div className="box-border caret-transparent gap-x-8 grid grid-cols-none gap-y-8 md:grid-cols-[repeat(3,minmax(0px,1fr))]">
                    ...
                    <ProjectCard imageUrl="https://i.postimg.cc/9MZ6bHmM/Real-Fit-VTON.jpg" projectLink="https://github.com/Shrinivas9370/RealFit.git" imageAlt="RealFit" title="RealFit" description="AI-Powered Virtual Garment Try-On Chrome Extension
...
Core Architecture: Features a robust frontend extension coupled with a high-performance FastAPI backend.
Infrastructure: Self-hosted and managed entirely on Lightning AI, optimizing GPU resources for lightning-fast inference and zero-lag rendering." techStack={["React", "Express.js", "AI/ML","Hugging Face","FAST API","TensorFlow"]} achievements={["Leverages a cutting-edge, diffusion-based Fashn AI VTON (Virtual Try-On) model to generate highly realistic, texture-accurate clothing overlays.",]} buttonIcon="https://c.animaapp.com/mmq5nl3br7cuRw/assets/icon-17.svg" buttonText="GitHub" buttonLink="https://github.com/Shrinivas9370/RealFit.git"  />      </div>
            </div>
        </section>
    );
};
